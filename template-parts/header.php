                ...
                <div id="header-content" class="clearfix">
                    <nav id="nav">
                        <ul class="sf-menu">
                            ...
                            <li><a href="list-air.php">Air Mineral</a>
                                <ul>
                                    <li><a href="list-air.php">List Air Mineral</a></li>
                                    <li><a href="tambah-air.php">Tambah Air Mineral</a></li>
                                </ul>
                            </li>
                            <?php endif; ?>
                            <li><a href="ranking-saw.php">Pilih Tipe Metode!</a>
                                <ul>
